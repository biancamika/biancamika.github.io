    ...
    return (
        <section className="w-full flex items-center justify-center p-20">
            <article className="prose w-full max-w-3xl">
                <img src="/profile-pic.jpg" className="size-[25%]" />
                <h2 className="mt-8">Hi there! I'm Bianca.</h2>
                <p>For the past ~5 years, I’ve been working as a design generalist for startups, investors, studios, and communities across fields like AI, Web3, and edtech. Sketching screens, crafting graphics, writing code...you name it, I’ve probably done it. I thrive best in the 0 → 1 stage, where I <strong>help turn ambiguous visions into concrete artifacts</strong> — especially when I get to build them out myself.</p>
